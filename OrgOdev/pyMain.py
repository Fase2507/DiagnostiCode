...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        if face_count < max_photos:
            ...
            Face.byteCode("Face/face_bytecode.txt")
            Face.parse("Face/face_parse.txt")
            Face.create_dir()
            face_count += 1
        ...
        for i, (ex, ey, ew, eh) in enumerate(eyes):
            if eye_count < max_photos:
                ...
                Eye.byteCode("Eye/eye_bytecode.txt")
                Eye.parse("Eye/eye_parse.txt")
                Eye.create_dir()
                eye_count += 1
                break
        ...
        for (mx, my, mw, mh) in mouths:
            if my > h / 2 and mouth_count < max_photos:
                ...
                Mouth.byteCode("Mouth/mouth_bytecode.txt")
                Mouth.parse("Mouth/mouth_parse.txt")
                Mouth.create_dir()
